...
The missing values should be taken into consideration before making the
ggplots
...
the time in the year, it does not snow and hence it is 0. The three most
commonly observed values are 25 (31022), 13 (23095), 51 (18274) (when we
don’t consider the times when there was no snowfall (0) and missing
values (NA)).

Creating plot showing the average max temperature in January and in July
